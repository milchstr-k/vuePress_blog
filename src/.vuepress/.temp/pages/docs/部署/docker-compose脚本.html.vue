<template><div><h1 id="docker-compose脚本" tabindex="-1"><a class="header-anchor" href="#docker-compose脚本" aria-hidden="true">#</a> docker-compose脚本</h1>
<blockquote>
<p>📌 <strong>关键词：</strong> docker-compose、脚本</p>
</blockquote>
<h2 id="kafka3" tabindex="-1"><a class="header-anchor" href="#kafka3" aria-hidden="true">#</a> Kafka3</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>配置参考：<a href="https://github.com/apache/kafka/blob/trunk/config/kraft/server.properties" target="_blank" rel="noopener noreferrer">https://github.com/apache/kafka/blob/trunk/config/kraft/server.properties<ExternalLinkIcon/></a></p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>进入kafka容器
